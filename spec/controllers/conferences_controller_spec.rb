...
RSpec.describe ConferencesController, type: :controller do
  ...
  let(:valid_attributes) { { name: "Great Conference", starts_on: Date.today, ends_on: Date.today + 2.days } }
